...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Plant Health Solutions Pvt. Ltd. — Innovative Agricultural Solutions" },
      {
        name: "description",
        content:
          "Bio fertilizers, biostimulants, micronutrients, water soluble fertilizers and crop protection products from our research center at Tidagundi, Vijayapura.",
      },
      { property: "og:title", content: "Plant Health Solutions Pvt. Ltd." },
      {
        property: "og:description",
        content: "Innovative agricultural solutions for sustainable farming across Karnataka and Maharashtra.",
      },
    ],
  }),
  component: Home,
    ...
    <div>
      ...
      <Section title="Rooted in Research, Grown with Farmers" kicker="Company Overview">
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <Link to="/about" className="mt-6 inline-block rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-secondary">
              Read our story
            </Link>
          </div>
        </div>
      ...
      <Section title="Latest Research & Agronomy" kicker="From Our Desk" muted>
        <div className="grid gap-5 md:grid-cols-3">
          {latest.map((b) => (
            <Link key={b.id} to="/blog/$id" params={{ id: b.id }} className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
...
export function Section({
  ...
  return (
    <section className={muted ? "bg-muted/60 py-16" : "py-16"}>
