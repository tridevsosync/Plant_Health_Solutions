...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      { title: "Agronomy & Research Blog — Plant Health Solutions" },
      { name: "description", content: "Field-tested agronomy articles on soil health, nutrition, irrigation and crop protection." },
      { property: "og:title", content: "Agronomy & Research Blog — Plant Health Solutions" },
      { property: "og:description", content: "Field-tested agronomy articles on soil health, nutrition, irrigation and crop protection." },
    ],
  }),
  component: BlogList,
});
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        {featured && (
          <Link to="/blog/$id" params={{ id: featured.id }} className="mb-10 grid overflow-hidden rounded-2xl border border-border bg-card shadow-sm md:grid-cols-2">
