...
export const Route = createFileRoute("/blog/$id")({
  head: () => ({
    meta: [
      { title: "Article — Plant Health Solutions" },
      { name: "description", content: "Full agronomy article from the Plant Health Solutions research team." },
      { property: "og:title", content: "Article — Plant Health Solutions" },
      { property: "og:description", content: "Full agronomy article from the Plant Health Solutions research team." },
    ],
  }),
  ...
  if (!blog) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-24 text-center">
        ...
        <Link to="/blog" className="mt-4 inline-block text-secondary underline">Back to blog</Link>
      </div>
    );
  }
