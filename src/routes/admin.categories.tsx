...
export const Route = createFileRoute("/admin/categories")({
  head: () => ({
    meta: [
      { title: "Categories — PHS Admin" },
      { name: "description", content: "Manage product categories for the Plant Health Solutions catalogue." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Categories — PHS Admin" },
