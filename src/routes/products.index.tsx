...
export const Route = createFileRoute("/products/")({
  ...
  head: () => ({
    meta: [
      { title: "Agricultural Products Catalog — Plant Health Solutions" },
      {
        name: "description",
        content:
          "Browse 30+ bio fertilizers, organic manures, micronutrients, water soluble fertilizers and crop protection products with farmer pricing.",
      },
      { property: "og:title", content: "Product Catalog — Plant Health Solutions" },
      { property: "og:description", content: "Research-backed agricultural inputs for every crop stage." },
    ],
  }),
  component: Catalog,
});
