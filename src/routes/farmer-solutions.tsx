...
export const Route = createFileRoute("/farmer-solutions")({
  head: () => ({
    meta: [
      { title: "Farmer Solutions — Crop Advisory | Plant Health Solutions" },
      {
        name: "description",
        content:
          "Crop-wise advisory for cotton, sugarcane, paddy, wheat, maize, vegetables and fruits: diseases, pests, nutrition schedule and season calendar.",
      },
      { property: "og:title", content: "Crop Advisory — Plant Health Solutions" },
      { property: "og:description", content: "Disease, pest, nutrition and season guidance for major Indian crops." },
    ],
  }),
  component: FarmerSolutions,
});
