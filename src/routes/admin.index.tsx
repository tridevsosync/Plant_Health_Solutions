...
export const Route = createFileRoute("/admin/")({
  head: () => ({
    meta: [
      { title: "Dashboard — PHS Admin" },
      { name: "description", content: "Revenue, orders, products and customer overview for Plant Health Solutions." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Dashboard — PHS Admin" },
      { property: "og:description", content: "Revenue and order overview." },
    ],
  }),
  component: Dashboard,
});
    ...
    <AdminPage title="Dashboard" subtitle="Live snapshot of store performance.">
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link to="/admin/orders" className="text-sm font-semibold text-secondary">
            View all
          </Link>
        </div>
        <TableWrap>
