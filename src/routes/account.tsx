...
export const Route = createFileRoute("/account")({
  head: () => ({
    meta: [
      { title: "My Account — Plant Health Solutions" },
      { name: "description", content: "Register, sign in, manage your profile, wishlist and orders." },
      { property: "og:title", content: "My Account — Plant Health Solutions" },
      { property: "og:description", content: "Register, sign in, manage your profile, wishlist and orders." },
    ],
  }),
  component: Account,
});
                ...
                <tbody>
                  ...
                  {myOrders.map((o) => (
                    <tr key={o.id} className="border-b border-border">
                      ...
                      <td>{inr(o.total)}</td>
                      <td><Link to="/orders/$id" params={{ id: o.id }} className="text-secondary underline">Invoice</Link></td>
                    </tr>
                  ))}
                </tbody>
              </table>
