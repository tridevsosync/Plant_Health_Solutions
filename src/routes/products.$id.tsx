...
export const Route = createFileRoute("/products/$id")({
  head: () => ({
    meta: [
      { title: "Product Details — Plant Health Solutions" },
      { name: "description", content: "Full specification, benefits, dosage and farmer reviews for this PHS product." },
      { property: "og:title", content: "Product Details — Plant Health Solutions" },
      { property: "og:description", content: "Benefits, agronomic usage, ingredients and reviews." },
    ],
  }),
  component: Detail,
});
