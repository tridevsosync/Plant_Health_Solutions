...
export const Route = createFileRoute("/admin/products")({
  head: () => ({
    meta: [
      { title: "Products — PHS Admin" },
      { name: "description", content: "Add, edit and remove Plant Health Solutions catalogue products." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Products — PHS Admin" },
