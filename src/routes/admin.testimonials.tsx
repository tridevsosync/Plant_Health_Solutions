...
export const Route = createFileRoute("/admin/testimonials")({
  head: () => ({
    meta: [
      { title: "Testimonials — PHS Admin" },
      { name: "description", content: "Manage farmer testimonials shown across the website." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Testimonials — PHS Admin" },
      { property: "og:description", content: "Farmer testimonial management." },
    ],
  }),
