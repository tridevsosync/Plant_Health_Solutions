...
export const Route = createFileRoute("/admin/blogs")({
  head: () => ({
    meta: [
      { title: "Blogs — PHS Admin" },
      { name: "description", content: "Publish and edit agronomy research articles." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Blogs — PHS Admin" },
      { property: "og:description", content: "Agronomy article management." },
    ],
  }),
