...
export const Route = createFileRoute("/admin/coupons")({
  head: () => ({
    meta: [
      { title: "Coupons — PHS Admin" },
      { name: "description", content: "Create and manage promotional coupon codes for the PHS store." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Coupons — PHS Admin" },
      { property: "og:description", content: "Promotional coupon management." },
    ],
  }),
