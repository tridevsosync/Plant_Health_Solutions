...
const paragraphs = [
  "Orders are dispatched from our Tidagundi, Vijayapura facility within 24 to 48 working hours of confirmation.",
  ...
  "Shipping is free on all orders above Rs. 2,000. A flat charge of Rs. 90 applies to smaller orders. Bulk and dealer consignments are moved by surface transport with separate freight terms.",
